    ...
    <div>
        ...
        <header id="header" class="fixed-top">
            <div class="container-fluid d-flex">
                ...
                <div class="logo mr-auto">
                    <h1 class="text-light font-weight-bold"><a href="/"><span>Agency</span></a></h1>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1">
              ...
              <h2>We are team of talanted designers making websites with best and newest technologies</h2>
        ...
        <section id="contact" class="contact">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-12 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
      ...
      <footer id="footer">
        ...
        <div class="container py-4">
          <div class="copyright">
            &copy; Copyright <strong><span>Agency</span></strong>. All Rights Reserved
          </div>
        </div>
      </footer><!-- End Footer -->
    </div>
